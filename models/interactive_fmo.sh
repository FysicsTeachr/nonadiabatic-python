...
TOTAL_TRAJECTORIES=160
BASE_ARGM_FILE="params_fmo.argm"
# UPDATED: Path to main.py in the new structure
PYTHON_SCRIPT="../exciton_dynamics/main.py"
...
init_state              0
L                       0.366
# UPDATED: Path to Hel-7.txt in the new structure
Hel_file                ../Hel-7.txt
lambda_cm               35.0
gamma_fs                50.0
n_modes                 100
